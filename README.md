...
2. Download the xray.exe file version 25.3.6 or the latest available version and place it in the source code directory: https://github.com/XTLS/Xray-core/releases/tag/v25.3.6 , put it in the source code directory
